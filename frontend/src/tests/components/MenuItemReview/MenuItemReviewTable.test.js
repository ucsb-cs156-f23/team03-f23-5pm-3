...
describe("MenuItemReview tests", () => {
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <MenuItemReviewTable review={menuItemReviewFixtures.threeReviews} currentUser={currentUser} />
        </MemoryRouter>
      </QueryClientProvider>
    );
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-itemid`)).toHaveTextContent("6");
