...
describe("UCSBDiningCommonsMenuItemEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            expect(nameField).toHaveValue("Turkey");
            ...
            expect(mockToast).toBeCalledWith("UCSB Dining Commons Menu Item Updated - id: 17 name: Turkey");
            ...
            expect(axiosMock.history.put[0].data).toBe(JSON.stringify({
                diningCommonsCode: 'Portola Dining Commons',
                name: 'Turkey',
                station: 'Entree'
            })); // posted object
