...
export default function UCSBOrganizationEditPage({storybook=false}) {
  ...
  const onSuccess = (ucsbOrganization) => {
    toast(`UCSBOrganization Updated - id: ${ucsbOrganization.orgcode} orgTranslationShort: ${ucsbOrganization.orgTranslationShort} orgTranslation: ${ucsbOrganization.orgTranslation} inactive: ${ucsbOrganization.inactive}`);
  }
