...
public class RecommendationRequestControllerTests extends ControllerTestCase {
        ...
        public void logged_in_user_can_get_all_() throws Exception {
                ...
                LocalDateTime dateNeeded = LocalDateTime.parse("2020-01-03T00:00:00");
                ...
                LocalDateTime dateRequested2 = LocalDateTime.parse("2022-05-03T00:00:00");
                LocalDateTime dateNeeded2 = LocalDateTime.parse("2020-09-03T00:00:00");

                RecommendationRequest recommendationRequest2 = RecommendationRequest.builder()
                                .requesterEmail("requester2@email.com")
                                .professorEmail("prof2@email.com")
        ...
        public void an_admin_user_can_post_a_new_ucsbdate() throws Exception {
                ...
                LocalDateTime dateRequested = LocalDateTime.parse("2022-01-03T00:00:00");
                LocalDateTime dateNeeded = LocalDateTime.parse("2020-04-03T00:00:00");
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/recommendationrequests/post?requesterEmail=requester@email.com&professorEmail=prof@email.com&explanation=Test explanation&dateRequested=2022-01-03T00:00:00&dateNeeded=2020-04-03T00:00:00&done=true")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_edit_an_existing_recommendationrequest() throws Exception {
                ...
                RecommendationRequest recommendationRequestOriginal = RecommendationRequest.builder()
                                .requesterEmail("requester@email.com")
                                .professorEmail("prof@email.com")
                                .explanation("Test explanation")
                                .dateRequested(dateRequested)
                ...
                LocalDateTime dateRequestedEdited = LocalDateTime.parse("1999-01-03T00:00:00");
                LocalDateTime dateNeededEdited = LocalDateTime.parse("1999-04-03T00:00:00");

                RecommendationRequest recommendationRequestEdited = RecommendationRequest.builder()
                .requesterEmail("new-requester@email.com")
                .professorEmail("new-prof@email.com")
                .explanation("Test explanation updated")
                .dateRequested(dateRequestedEdited)
                .dateNeeded(dateNeededEdited)
                .done(true)
                .build();

                String requestBody = mapper.writeValueAsString(recommendationRequestEdited);

                when(recommendationRequestRepository.findById(eq(67L))).thenReturn(Optional.of(recommendationRequestOriginal));
